...
namespace Microsoft.Iris.Render.Graphics
{
    internal class Dx9PointLight2DElement
    {
          ...
          ref Dx9EffectBuilder effectBuilder)
        {
            ...
            {
                ID = (int)efiPointLight2D.PositionID,
            ...
            variableInfo2.DefaultValue = (object)efiPointLight2D.Radius;
            effectBuilder.AddPropertyVariable(variableInfo2);
            VariableInfo variableInfo3 = new VariableInfo()
            {
                ID = (int)efiPointLight2D.LightColorID,
            ...
            variableInfo3.DefaultValue = (object)efiPointLight2D.LightColor.ToVector4();
            effectBuilder.AddPropertyVariable(variableInfo3);
            VariableInfo variableInfo4 = new VariableInfo()
            {
                ID = (int)efiPointLight2D.AmbientColorID,
                Type = Dx9VariableType.Vector4,
            ...
            variableInfo4.DefaultValue = (object)efiPointLight2D.AmbientColor.ToVector4();
            effectBuilder.AddPropertyVariable(variableInfo4);
            VariableInfo variableInfo5 = new VariableInfo()
            {
                ID = (int)efiPointLight2D.AttenuationID,
                Type = Dx9VariableType.Vector3,
            ...
            variableInfo5.DefaultValue = (object)efiPointLight2D.Attenuation;
