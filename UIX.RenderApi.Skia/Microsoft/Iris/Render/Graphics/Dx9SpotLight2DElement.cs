...
namespace Microsoft.Iris.Render.Graphics
{
    internal class Dx9SpotLight2DElement
    {
          ...
          ref Dx9EffectBuilder effectBuilder)
        {
            ...
            {
                ID = (int)efiSpotlight2D.PositionID,
            ...
            variableInfo1.DefaultValue = (object)efiSpotlight2D.Position;
            effectBuilder.AddPropertyVariable(variableInfo1);
            VariableInfo variableInfo2 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.DirectionAngleID,
            ...
            variableInfo2.DefaultValue = (object)efiSpotlight2D.DirectionAngle;
            effectBuilder.AddPropertyVariable(variableInfo2);
            VariableInfo variableInfo3 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.LightColorID,
            ...
            variableInfo3.DefaultValue = (object)efiSpotlight2D.LightColor.ToVector4();
            effectBuilder.AddPropertyVariable(variableInfo3);
            VariableInfo variableInfo4 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.AmbientColorID,
                Type = Dx9VariableType.Vector4,
            ...
            variableInfo4.DefaultValue = (object)efiSpotlight2D.AmbientColor.ToVector4();
            effectBuilder.AddPropertyVariable(variableInfo4);
            VariableInfo variableInfo5 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.InnerConeAngleID,
                Type = Dx9VariableType.Float,
            ...
            variableInfo5.DefaultValue = (object)efiSpotlight2D.InnerConeAngle;
            effectBuilder.AddPropertyVariable(variableInfo5);
            VariableInfo variableInfo6 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.OuterConeAngleID,
                Type = Dx9VariableType.Float,
            ...
            variableInfo6.DefaultValue = (object)efiSpotlight2D.OuterConeAngle;
            effectBuilder.AddPropertyVariable(variableInfo6);
            VariableInfo variableInfo7 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.IntensityID,
                Type = Dx9VariableType.Float,
            ...
            variableInfo7.DefaultValue = (object)efiSpotlight2D.Intensity;
            effectBuilder.AddPropertyVariable(variableInfo7);
            VariableInfo variableInfo8 = new VariableInfo()
            {
                ID = (int)efiSpotlight2D.AttenuationID,
                Type = Dx9VariableType.Vector3,
            ...
            variableInfo8.DefaultValue = (object)efiSpotlight2D.Attenuation;
